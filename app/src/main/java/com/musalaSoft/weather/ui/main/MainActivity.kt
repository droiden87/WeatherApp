...
import com.musalaSoft.weather.core.BaseActivity
import com.musalaSoft.weather.core.Constants
import com.musalaSoft.weather.databinding.ActivityMainBinding
import com.musalaSoft.weather.utils.extensions.hide
import com.musalaSoft.weather.utils.extensions.show
...
class MainActivity : BaseActivity<MainActivityViewModel, ActivityMainBinding>(MainActivityViewModel::class.java), HasAndroidInjector, NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun setLocation(){
        val preferences = this.getSharedPreferences(getString(R.string.prefs_name), MODE_PRIVATE)
        preferences.edit().putString(Constants.Coords.LAT, 42.6977.toString()).apply()
        preferences.edit().putString(Constants.Coords.LON, 23.3219.toString()).apply()
